...
print("=== ASHTE MOBILE: ALL FILE.IPAOMTK.COM MASSIVE LIBRARY ===")

json_file = "ashtemobile94.json"

# گەورەترین و پڕترین لیستی هەزاران یاری و ئەپ کە ڕاستەوخۆ لەسەر سێرڤەری file.ipaomtk.com کار دەکەن
massive_library = [
    # یارییە بەناوبانگ و ئاكشنەکان
    ...
    # ئەپ و سۆشیاڵ میدیا بەناوبانگەکان
...
for item in massive_library:
    name = item["name"]
    slug = item["slug"]
    size_str = item["size"]
    version = item["version"]
    
    # لینکی ڕەسەنی file.ipaomtk.com
    ...
    print(f" + Added direct file item: {name}")
...
print(f"\nSUCCESS! Generated {len(apps_list)} direct files with file.ipaomtk.com links into {json_file}.")
